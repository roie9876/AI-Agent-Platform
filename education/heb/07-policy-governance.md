...
## נוף התעשייה: Guardrails בעולם האמיתי (Industry Tools)

כיצד חברות בונות "מעקות בטיחות" כיום?

| כלי מחקר / פלטפורמה | סוג | שימוש ואופי |
|---------------------|-----|-------------|
| **Azure AI Content Safety** | שירות ענן מנוהל | מערכת מוכנה מראש לזיהוי שיח שנאה, אלימות, פריצת הגדרות (Jailbreaks) של המודל, ללא צורך בהקמת שרת. |
| **NeMo Guardrails (NVIDIA)** | קוד פתוח (פייתון) | מגדיר "מסילות" להתנהגות הסוכן - למשל "מותר לך לדבר רק על נהלי משאבי אנוש". משתמש בסינטקס מיוחד הנקרא Colang. |
| **Llama Guard (Meta)** | מודל כשומר סף (LLM-as-a-judge) | מודל קטן מהיר ויעיל שאומן במיוחד רק למטרה אחת: להסתכל על פרומפטים של משתמשים ולקבוע האם הם בטוחים טרם העברתם למודל הגדול. |
