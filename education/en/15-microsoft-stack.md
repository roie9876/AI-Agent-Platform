...
- [Azure Stack Pros and Cons](#azure-stack-pros-and-cons)
- [Summary and Questions](#summary-and-questions)

---

## Mapping HLD to Azure

### Every generic component → Specific Azure product:

| HLD Component (Generic) | Azure Product | Why? |
|-------------------------|---------------|------|
...
### What is it?
**Azure OpenAI** = An Azure service that provides access to OpenAI models (GPT-4o, GPT-4o-mini, Embeddings) with enterprise-grade security.
...
| Term | Explanation |
|------|-------------|
| **TPM** | Tokens Per Minute - how many tokens can be consumed |
| **Deployment** | An instance of a model with defined capacity |
| **Provisioned** | Reserved capacity (fast, expensive) |
...
### What is it?
**Azure AI Search** = A search service that supports **Vector Search**, **Full-Text Search**, and **Hybrid Search**.
...
### What is it?
**Azure Cosmos DB** = A globally distributed NoSQL database with low-latency guarantees.
...
### Why Cosmos DB for an Agent Platform?
...
### What is it?
**APIM** = Azure's API Gateway. Manages all API traffic.
...
### What is it?
**Azure AI Content Safety** = A service that detects harmful content (violence, hate, sexual, self-harm).
...
### What is it?
**Azure AI Foundry** (formerly Azure AI Studio) = A full platform for developing AI Apps and Agents.
...
### What is it?
**Semantic Kernel** = Microsoft's SDK for building AI Agents. It is the "framework" for writing Agent logic.
...
## Azure Stack Pros and Cons

| ✅ Advantage | ❌ Disadvantage |
|-------------|----------------|
| All services in one cloud | Vendor lock-in |
| Native integration between services | Some services are expensive |
...
1. Map every generic component from the HLD to a specific Azure service (15 components).
2. Why Azure OpenAI and not OpenAI directly?
3. What is the advantage of Hybrid Search in Azure AI Search?
4. Why is Cosmos DB suitable for an Agent Platform (4 reasons)?
5. What is the difference between ACA and AKS, and when to use each?
6. What is Managed Identity and why is it better than API keys?
7. What is Semantic Kernel and how is it different from LangChain?
8. What does the Azure AI Foundry Agent Service provide?
...
<details>
<summary>1. Map every generic component to an Azure service.</summary>
...
<details>
<summary>2. Why Azure OpenAI and not OpenAI directly?</summary>

1. **Data stays in Azure** - doesn't leave to OpenAI, meets compliance requirements (GDPR, SOC2).
2. **Managed Identity** - no API keys needed.
3. **Private Endpoints** - traffic over private network.
4. **Content Filtering** - built-in.
5. **PTU (Provisioned Throughput)** - guaranteed capacity for enterprise.
6. **SLA** - 99.9% uptime with support.
</details>

<details>
<summary>3. What is the advantage of Hybrid Search in Azure AI Search?</summary>

**Hybrid Search** combines **Keyword (BM25) + Semantic (Vector)** and merges results with RRF (Reciprocal Rank Fusion). Advantages: (1) Gets the precision of keyword search (terms, names) + semantic understanding (similar meanings), (2) More accurate results than either method alone, (3) In Azure AI Search it's built-in and easy to enable.
</details>

<details>
<summary>4. Why is Cosmos DB suitable for an Agent Platform (4 reasons)?</summary>

1. **Low Latency** - single-digit ms reads/writes, critical for real-time agents.
2. **Multi-Model** - supports JSON, Key-Value, Graph → suitable for storing config, state, threads.
3. **Global Distribution** - multi-region writes → Active-Active.
4. **Elastic Scale** - auto scale RU/s based on load, no need to provision in advance.
</details>

<details>
<summary>5. What is the difference between ACA and AKS?</summary>

**ACA (Azure Container Apps)** = PaaS for containers. No need to manage K8s, built-in auto-scaling, scale to zero. Suitable for: most cases (80%), simple and fast. **AKS (Azure Kubernetes Service)** = IaaS+, full control over K8s. Suitable for: complex cases, custom networking, service mesh, GPU nodes.
</details>

<details>
<summary>6. What is Managed Identity and why is it better than API keys?</summary>

**Managed Identity** = An identity that Azure automatically manages for a service. The service connects to other services without an API key in the code. Better because: (1) **No secrets to manage** - nothing to leak/rotate/forget, (2) **Automatic rotation**, (3) **RBAC** - integrates with Entra ID.
</details>

<details>
<summary>7. What is Semantic Kernel and how is it different from LangChain?</summary>

**Semantic Kernel** = Microsoft's SDK for building AI applications. **Differences from LangChain**: (1) **Enterprise-first** - optimized for Azure, (2) **C# + Python + Java** (not just Python), (3) **Plugins** architecture (modular), (4) **Fewer abstractions** - easier to understand. LangChain: more popular in the community, richer in third-party integrations.
</details>

<details>
<summary>8. What does the Azure AI Foundry Agent Service provide?</summary>

**Azure AI Foundry Agent Service** = A managed Azure service for building AI Agents. Provides: (1) **Managed Runtime** - no need to manage infra, (2) **Built-in integration** with Azure OpenAI, AI Search, Bing, (3) **Built-in Thread/State management**, (4) **Ready-made Code Interpreter** and File tools, (5) **Enterprise features** - security, compliance, monitoring. Essentially a PaaS for Agent Platform.
</details>
