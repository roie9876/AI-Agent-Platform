...
## 🌍 Industry Landscape: Agent Frameworks

Before we build, here's what the industry uses to build agents in production:
...
|----------|--------|--------|
| **Azure OpenAI** | GPT-4.1, GPT-4o, GPT-4o-mini | Enterprise, SLA, compliance ✅ (what we use) |
